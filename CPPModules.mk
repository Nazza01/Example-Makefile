...
#    Updated: 2022/08/07 22:04:59 by Nathanael        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CLEAN_LST	=	$(NAME) $(LOG)
FCLN_LST	=	$(BUILD_DIR) $(SHRUB_FL) $(LOG)
...
cv:
	...
	docker stop $(VALGRND_NAME) 2>&1 || true && docker rm $(VALGRND_NAME) 2>&1 || true
